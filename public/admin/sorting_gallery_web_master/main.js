...
const initialTemplate = `<div class="card-box empty-box">
    <div class="inner-card no-img">
        <div class="img-box">
            <img src="admin/sorting_gallery_web_master/assets/image.png" alt="">
        </div>
    </div>
    </div>
`;
     ...
     <div class="inner-card">
         ...
         <div class="tools-img">
             <div class="icon view" onclick="showImg(this)">
                 <img src="admin/sorting_gallery_web_master/icons/view.svg" alt="">
             </div>
             <div class="icon crop" onclick="cropImg(this)">
                 <img src="admin/sorting_gallery_web_master/icons/icons/crop.svg" alt="">
             </div>
