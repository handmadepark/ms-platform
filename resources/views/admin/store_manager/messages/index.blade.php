...
@section('content')
    <div class="main-content app-content">
        ...
        <div class="main-container container-fluid">
                        ...
                        <div class="main-content-left main-content-left-mail card-body">
                            ...
                            <div class="main-mail-menu">
                                <nav class="nav main-nav-column mg-b-20">
                                    <a class="nav-link thumb" href="javascript:void(0);"><i class="far fa-envelope"></i> Inbox <span>20</span></a>
                                    ...
                                    <a class="nav-link thumb active" href="javascript:void(0);"><i class="fas fa-trash"></i> Trash <span>6</span></a>
                                </nav>
                        ...
                        <div class="card-body">
                            ...
                            <nav class="nav main-nav-column">
                                <div class="main-contact-item ps-0">
                                    <div class="main-img-user online"><img alt="avatar" src="{{asset('admin/img/faces/2.jpg')}}"></div>
                                    <div class="main-contact-body">
                                        <h6>Abigail Johnson</h6><span class="phone">+1-234-567-890</span>
                                    </div>
                                </div>
                                <div class="main-contact-item ps-0">
                                    <div class="main-img-user online"><img alt="avatar" src="{{asset('admin/img/faces/1.jpg')}}"></div>
                                    <div class="main-contact-body">
                                        <h6>Cherry Blossom</h6><span class="phone">+1-644-767-890</span>
                                    </div>
                                </div>
                                <div class="main-contact-item ps-0">
                                    <div class="main-img-user online"><img alt="avatar" src="{{asset('admin/img/faces/12.jpg')}}"></div>
                                    <div class="main-contact-body">
                                        <h6>Liz Erd</h6><span class="phone">+1-634-577-890</span>
                                    </div>
                                </div>
                                <div class="main-contact-item ps-0">
                                    <div class="main-img-user online"><img alt="avatar" src="{{asset('admin/img/faces/11.jpg')}}"></div>
                                    <div class="main-contact-body">
                                        <h6>Colin Sik</h6><span class="phone">+1-834-367-890</span>
                                    </div>
                                </div>
                                <div class="main-contact-item ps-0">
                                    <div class="main-img-user online"><img alt="avatar" src="{{asset('admin/img/faces/4.jpg')}}"></div>
                                    <div class="main-contact-body">
                                        <h6>Rita Book</h6><span class="phone">+1-233-867-830</span>
                                    </div>
                                </div>
                                <div class="main-contact-item ps-0">
                                    <div class="main-img-user online"><img alt="avatar" src="{{asset('admin/img/faces/5.jpg')}}"></div>
                                    <div class="main-contact-body">
                    ...
                    <div class="card">
                        <div class="main-content-body main-content-body-mail card-body">
                            <div class="mail-option">
                                ...
                                <div class="btn-group hidden-phone">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="javascript:void(0);"><i class="fas fa-edit me-2"></i> Mark as Read</a></li>
                                        <li><a href="javascript:void(0);"><i class="fas fa fe-slash me-2"></i> Spam</a></li>
                                        <li class="divider"></li>
                                        <li><a href="javascript:void(0);"><i class="fas fa-trash me-2"></i> Delete</a></li>
                                    </ul>
                                </div>
                                <ul class="unstyled inbox-pagination">
                                    ...
                                    <li class="mt-1">
                                        <a class="btn np-btn" href="javascript:void(0);"><i class="fas fa-chevron-right pagination-right"></i></a>
                                    </li>
                                </ul>
                        ...
                        <div class="main-mail-list bd-t-0">
                            <div class="main-mail-item unread">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/5.jpg')}}"></div>
                            ...
                            <div class="main-mail-item unread">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/2.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Albert Ansing
                                    </div>
                            ...
                            <div class="main-mail-item">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/9.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Carla Guden
                                    </div>
                            ...
                            <div class="main-mail-item unread">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/10.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Reven Galeon
                                    </div>
                            ...
                            <div class="main-mail-item">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/12.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Elisse Tan
                                    </div>
                            ...
                            <div class="main-mail-item">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/14.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Marianne Audrey
                                    </div>
                            ...
                            <div class="main-mail-item">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/15.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Raffy Godinez
                                    </div>
                            ...
                            <div class="main-mail-item">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/7.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Allan Cadungog
                                    </div>
                            ...
                            <div class="main-mail-item border-bottom-0">
                                ...
                                <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/1.jpg')}}"></div>
                                <div class="main-mail-body">
                                    <div class="main-mail-from">
                                        Jove Guden
                                    </div>
            ...
            <div class="main-mail-compose main-mail-compose-compress" style="display: none;">
                <div>
                    <div class="container">
                        <div class="main-mail-compose-box">
                            <div class="main-mail-compose-header">
                                ...
                                <nav class="nav">
                                    <a class="nav-link" href="#"><i class="fas fa-minus"></i></a> <a class="nav-link" href="#"><i class="fas fa-expand"></i></a> <a class="nav-link" href="#"><i class="fas fa-times"></i></a>
                                </nav>
                            </div>
                            <div class="main-mail-compose-body">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Write your message here..." rows="8" style="height: 104px;"></textarea>
                                </div>
                                <div class="form-group mg-b-0">
                                    <nav class="nav">
                                        <a class="nav-link" data-bs-toggle="tooltip" href="#" title="" data-bs-original-title="Add attachment" aria-label="Add attachment"><i class="fas fa-paperclip"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="#" title="" data-bs-original-title="Add photo" aria-label="Add photo"><i class="far fa-image"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="#" title="" data-bs-original-title="Add link" aria-label="Add link"><i class="fas fa-link"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="#" title="" data-bs-original-title="Emoticons" aria-label="Emoticons"><i class="far fa-smile"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="#" title="" data-bs-original-title="Discard" aria-label="Discard"><i class="far fa-trash-alt"></i></a>
