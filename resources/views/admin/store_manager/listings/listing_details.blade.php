        ...
        <div class="main-container container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="left-content">
                    <span class="main-content-title mg-b-0 mg-b-lg-1">Listing DETAILS</span>
                </div>
                        ...
                        <div class="card-body ">
                            <div class="row row-sm ">
                                                ...
                                                <div id="thumbcarousel" class="carousel slide" data-bs-interval="t">
                                                    <div class="carousel-inner">
                                                        <ul class="carousel-item active">
                                                            <li data-bs-target="#Slider" data-bs-slide-to="0" class="thumb active my-2"><img src="{{asset('admin/img/ecommerce/shirt-1.png')}}" alt="img"></li>
                                                            <li data-bs-target="#Slider" data-bs-slide-to="1" class="thumb my-2"><img src="{{asset('admin/img/ecommerce/shirt-3.png')}}" alt="img"></li>
                                                            <li data-bs-target="#Slider" data-bs-slide-to="2" class="thumb my-2"><img src="{{asset('admin/img/ecommerce/shirt-4.png')}}" alt="img"></li>
                                                            <li data-bs-target="#Slider" data-bs-slide-to="3" class="thumb my-2"><img src="{{asset('admin/img/ecommerce/shirt-2.png')}}" alt="img"></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-10">
                                            <div class="product-carousel  border br-5">
                                                <div id="Slider" class="carousel slide" data-bs-ride="false">
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active"><img src="{{asset('admin/img/ecommerce/shirt-1.png')}}" alt="img" class="img-fluid mx-auto d-block">
                                                            <div class="text-center mt-5 mb-5 btn-list">
                                                            </div>
                                                        </div>
                                                        <div class="carousel-item"> <img src="{{asset('admin/img/ecommerce/shirt-3.png')}}" alt="img" class="img-fluid mx-auto d-block">
                                                            <div class="text-center mb-5 mt-5 btn-list">
                                                            </div>
                                                        </div>
                                                        <div class="carousel-item"> <img src="{{asset('admin/img/ecommerce/shirt-4.png')}}" alt="img" class="img-fluid mx-auto d-block">
                                                            <div class="text-center  mb-5 mt-5 btn-list">
                                                            </div>
                                                        </div>
                                                        <div class="carousel-item"> <img src="{{asset('admin/img/ecommerce/shirt-2.png')}}" alt="img" class="img-fluid mx-auto d-block">
                                                            <div class="text-center  mb-5 mt-5 btn-list">
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="details col-xl-6 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                    <h4 class="product-title mb-1">{{$item_selected->name}}</h4>
                                    <p class="text-muted tx-13 mb-1">
                                        @foreach($item_selected->getCategories as $cat)
                                            <p class="text-light">{{dd($cat)}}</p>
                                        @endforeach
                                    </p>
                                    ...
                                    <div class="sizes d-flex">sizes:
                                        <span class="size d-flex"><label class="rdiobox mb-0"><input checked="" name="rdio" type="radio"> <span>s</span></label></span>
                                        <span class="size d-flex"><label class="rdiobox mb-0"><input name="rdio" type="radio"> <span>m</span></label></span>
                                        <span class="size d-flex"><label class="rdiobox mb-0"><input name="rdio" type="radio"> <span>l</span></label></span>
                                        <span class="size d-flex"><label class="rdiobox mb-0"><input name="rdio" type="radio"> <span>xl</span></label></span>
                                    </div>
                                            ...
                                            <ul class=" mb-0 qunatity-list">
                                                <li>
                                                    <div class="form-group">
                                                        <select name="quantity" id="select-countries17" class="form-control nice-select wd-50" style="display: none;">
                                                            <option value="1" selected="">1</option>
                                                            <option value="2">2</option>
                                                            <option value="3">3</option>
                                                            <option value="4">4</option>
                                                        </select><div class="nice-select form-control wd-50" tabindex="0"><span class="current">1</span><ul class="list"><li data-value="1" class="option selected">1</li><li data-value="2" class="option">2</li><li data-value="3" class="option">3</li><li data-value="4" class="option">4</li></ul></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab7">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <td><i class="fa fa-check me-3 text-success"></i>Ocassion:Casual,
                                                            Formal</td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="media mt-0 p-3 border-bottom border-top">
                                <div class="d-flex me-3">
                                    <a href="javascript:void(0);"><img class="media-image avatar avatar-md rounded-circle" alt="64x64" src="{{asset('admin/img/faces/6.jpg')}}'"> </a>
                                </div>
                                <div class="media-body">
                                    <h5 class="mt-0 mb-1 font-weight-semibold tx-16">Bruce Tran
                                        <span class="fs-14 ms-0" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="verified"><i class="fa fa-check-circle-o text-success"></i></span>
                                    </h5>
                                    ...
                                    <p class="mb-1"> <a href="javascript:void(0);" class="me-2"><span class="badge badge-primary">Helpful</span></a>
                                        <a href="#" class="me-2"><span class="">Comment</span></a>
                                        <a href="#" class="me-2"><span class="">Report</span></a>
                                        <span class="float-end"> <a href="javascript:void(0)" class="new ms-3"><i class="text-success br-7 text-success fe fe-thumbs-up fs-16 text-icon "></i></a>
            ...
            <div class="row">
                    ...
                    <div class="card item-card">
                        <div class="card-body pb-0 h-100  product-grid6">
                            <div class="text-center product-image">
                                <img src="{{asset('admin/img/ecommerce/01.jpg')}}" alt="img" class="img-fluid">
                            </div>
                        ...
                        <div class="text-center border-top pt-3 pb-3 ps-2 pe-2 ">
                            ...
                            <a href="product-cart.html" class="btn btn-secondary mb-0 mb-lg-2"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="card item-card">
                        <div class="card-body pb-0 h-100  product-grid6">
                            <div class="text-center product-image">
                                <img src="{{asset('admin/img/ecommerce/08.jpg')}}" alt="img" class="img-fluid">
                            </div>
                            <div class="card-body cardbody relative">
                                <div class="cardtitle">
                ...
                <div class="col-lg-3">
                    <div class="card item-card">
                        <div class="card-body pb-0 h-100 product-grid6">
                            <div class="text-center product-image">
                                <img src="{{asset('admin/img/ecommerce/07.jpg')}}" alt="img" class="img-fluid">
                            </div>
                            <div class="card-body cardbody relative ">
                                <div class="cardtitle">
                                    <span class="h6 font-weight-bold text-uppercase">Fashion</span>
                ...
                <div class="col-lg-3">
                    <div class="card item-card">
                        <div class="card-body pb-0 h-100  product-grid6">
                            <div class="text-center product-image">
                                <img src="{{asset('admin/img/ecommerce/5.jpg')}}" alt="img" class="img-fluid">
                            </div>
                            <div class="card-body cardbody relative">
                                <div class="cardtitle">
