                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                    <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                            <a class="new nav-link profile-user d-flex" href="#" data-bs-toggle="dropdown"><img alt="" src="{{asset('admin/img/faces/2.jpg')}}" class=""></a>
                            <div class="dropdown-menu">
                                <div class="menu-header-content p-3 border-bottom">
                                    <div class="d-flex wd-100p">
                                        <div class="main-img-user"><img alt="" src="{{asset('admin/img/faces/2.jpg')}}" class=""></div>
                                        <div class="ms-3 my-auto">
                                            <h6 class="tx-15 font-weight-semibold mb-0">{{ Auth::user()->name }}</h6>
                                            <span class="dropdown-title-text subtext op-6  tx-12">Burda role olacaq</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item" href="{{route('admin.logout')}}"><i class="far fa-arrow-alt-circle-left"></i> Sign Out</a>
                            </div>
                        </li>
                    </ul>
                </div>
