            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <span class="side-menu__label">Category options</span><i class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{route('admin.shipping_informations')}}">Shipping Informations</a></li>
