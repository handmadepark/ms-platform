            ...
            <div class="row row-sm">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form action="{{route('admin.options.update', ['id'=>$item->id])}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="variation_id">Variation</label>
                                <select name="variation_id" id="variation_id" class="form-control">
                                    ...
                                    <option value="{{$variation->id}}" {{$item->variation_id==$variation->id ? 'selected' : ''}}>{{$variation->variation_name}}</option>
                                    @endforeach
                                </select>
